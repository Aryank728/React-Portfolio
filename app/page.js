...
export const metadata = generatePageMetadata({
  ...
  description:
    "Official portfolio of Aryan Kumar, Software Engineer specializing in DevOps, Azure, system architecture, and full-stack development. Explore projects, open-source work, and contact.",
  keywords:
